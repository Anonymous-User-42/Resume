...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {Bachelor of Engineering in \textbf{Computer Engineering}}{Sep. 2022 -- Exp. Aug. 2027}
      % {}{}
...
\section{Skills}
 \begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
     \textbf{Languages}{: C/C++, Python, VHDL, Assembly, JavaScript, MATLAB, LaTeX, Java, HTML/CSS} \\
     \textbf{Frameworks}{: GCC, LLVM/Clang, GDB, FreeRTOS, PlatformIO, JUnit, React.js, Node.js, APT, PIP} \\
     \textbf{Libraries}{: Tensorflow, NumPy, pandas, Matplotlib, AVR-LibC} \\
     ...
     \textbf{Protocols}{: UART, SPI, I2C, TCP/IP} \\
...
\section{Projects}
    \resumeSubHeadingListStart
      \resumeProjectHeading
          {\textbf{8-Bit Custom CPU Design \& FPGA Implementation} $|$ \emph{VHDL, FPGA, Quartus II, ModelSim, Git}}{Nov. 2023}
          ...
          \resumeItemListEnd
          \resumeProjectHeading
          {\textbf{Intelligent Home Energy Optimization System} $|$ \emph{C/C++, Arduino, Python, PlatformIO, Git}}{Feb. 2023}
          ...
          \resumeItemListEnd
          \resumeProjectHeading
          {\textbf{Firmware Engineer} $|$ \emph{C/C++, Arduino, ESP32/8266, Teensy, PlatformIO, Python, Git}}{Mar. 2024}
