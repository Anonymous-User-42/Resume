...
\resumeProjectHeading{\textbf{32-Bit RISC CPU Design \& Implementation} $|$ \emph{Verilog/VHDL, FPGA, Quartus II, ModelSim, Git}}{\textbf{Apr 2025}}
      ...
      {
      Designed and implemented a custom 32-bit RISC CPU in Verilog/VHDL, integrating a datapath, ALU, register file, control unit (FSM), and instruction memory to execute arithmetic, logic, and branching operations.
      ...
      \resumeItemListStart
        \resumeItem{Engineered a multi-cycle processor architecture with a 256-word x 32-bit RAM, optimizing ALU and control logic for efficient instruction execution.}
        \resumeItem{Simulated, verified, and synthesized CPU performance in Quartus II, leveraging ModelSim timing analysis to optimize instruction latency and FSM transitions.}
