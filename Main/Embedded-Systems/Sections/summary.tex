...
% \section{Summary of Qualifications}
    \resumeItemListStart
        ...
        \resumeItem{Third-year Computer Engineering student, \textbf{specializing in embedded systems}, \textbf{firmware development}, with hands-on experience in microcontroller-based design and \textbf{real-time applications}, and \textbf{proficient in C/C++ \& Python}; experienced with RTOS, Linux, and assembly language.}
